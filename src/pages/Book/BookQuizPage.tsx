...
import { useB1Quiz } from '../../hooks/useB1Quiz';
import { QuizQuestionCard } from './QuizQuestionCard';

export const BookQuizPage: React.FC = () => {
    const navigate = useNavigate();
    const { state, startQuiz, submitAnswer, nextQuestion } = useB1Quiz();

    // Removed local state input/feedback - handled in subcomponent now
            ...
            <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="space-y-2">
                        <h1 className="text-3xl font-bold text-slate-800">B1 Abschlusstest</h1>
