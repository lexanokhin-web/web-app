            ...
            <AnimatePresence mode="wait">
                <div className="absolute inset-0 flex items-center justify-center p-4 pointer-events-none">
                    ...
                    >
                        ...
                        {/* Footer */}
                        <div className="p-4 bg-gray-50/80 backdrop-blur-sm border-t flex justify-center flex-shrink-0">
                            <button
                                onClick={onClose}
                                className="w-full sm:w-auto px-12 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl font-bold shadow-lg shadow-blue-200 hover:shadow-xl transition-all active:scale-95"
                            >
                                Понятно
                            </button>
                        </div>
